...
#ifndef ISISMEPSV2_IVID5_PIU_TYPES_H_
#define ISISMEPSV2_IVID5_PIU_TYPES_H_
...
#define ISISMEPSV2_IVID5_PIU_NOP_ID {0x1A, 0x05, 0x02, 0x00}
#define ISISMEPSV2_IVID5_PIU_CANCEL_ID {0x1A, 0x05, 0x04, 0x00}
#define ISISMEPSV2_IVID5_PIU_RESETWATCHDOG_ID {0x1A, 0x05, 0x06, 0x00}
#define ISISMEPSV2_IVID5_PIU_OUTPUTBUSGROUPON_ID {0x1A, 0x05, 0x10, 0x00}
#define ISISMEPSV2_IVID5_PIU_OUTPUTBUSGROUPOFF_ID {0x1A, 0x05, 0x12, 0x00}
#define ISISMEPSV2_IVID5_PIU_OUTPUTBUSGROUPSTATE_ID {0x1A, 0x05, 0x14, 0x00}
#define ISISMEPSV2_IVID5_PIU_OUTPUTBUSCHANNELON_ID {0x1A, 0x05, 0x16, 0x00}
#define ISISMEPSV2_IVID5_PIU_OUTPUTBUSCHANNELOFF_ID {0x1A, 0x05, 0x18, 0x00}
#define ISISMEPSV2_IVID5_PIU_SWITCHTONOMINAL_ID {0x1A, 0x05, 0x30, 0x00}
#define ISISMEPSV2_IVID5_PIU_SWITCHTOSAFETY_ID {0x1A, 0x05, 0x32, 0x00}
#define ISISMEPSV2_IVID5_PIU_GETSYSTEMSTATUS_ID {0x1A, 0x05, 0x40, 0x00}
#define ISISMEPSV2_IVID5_PIU_GETOVERCURRENTFAULTSTATE_ID {0x1A, 0x05, 0x42, 0x00}
#define ISISMEPSV2_IVID5_PIU_GETCONFIGURATIONPARAMETER_ID {0x1A, 0x05, 0x82, 0x00}
#define ISISMEPSV2_IVID5_PIU_SETCONFIGURATIONPARAMETER_ID {0x1A, 0x05, 0x84, 0x00}
#define ISISMEPSV2_IVID5_PIU_RESETCONFIGURATIONPARAMETER_ID {0x1A, 0x05, 0x86, 0x00}
#define ISISMEPSV2_IVID5_PIU_RESETCONFIGURATION_ID {0x1A, 0x05, 0x90, 0x00}
#define ISISMEPSV2_IVID5_PIU_LOADCONFIGURATION_ID {0x1A, 0x05, 0x92, 0x00}
#define ISISMEPSV2_IVID5_PIU_SAVECONFIGURATION_ID {0x1A, 0x05, 0x94, 0x00}
#define ISISMEPSV2_IVID5_PIU_GETHOUSEKEEPINGRAW_ID {0x1A, 0x05, 0xA0, 0x00}
#define ISISMEPSV2_IVID5_PIU_GETHOUSEKEEPINGRAWINCDB_ID {0x1A, 0x05, 0xA0, 0x00}
#define ISISMEPSV2_IVID5_PIU_GETHOUSEKEEPINGENG_ID {0x1A, 0x05, 0xA2, 0x00}
#define ISISMEPSV2_IVID5_PIU_GETHOUSEKEEPINGENGINCDB_ID {0x1A, 0x05, 0xA2, 0x00}
#define ISISMEPSV2_IVID5_PIU_GETHOUSEKEEPINGENGRUNNINGAVGINCDB_ID {0x1A, 0x05, 0xA4, 0x00}
#define ISISMEPSV2_IVID5_PIU_GETHOUSEKEEPINGRUNNINGAVG_ID {0x1A, 0x05, 0xA4, 0x00}
#define ISISMEPSV2_IVID5_PIU_RESET_ID {0x1A, 0x05, 0xAA, 0x00}


/* ENUMS */

/*!
 * Enumeration of all ISISPACE EPS channels
 */
typedef enum __attribute__ ((__packed__)) isismepsv2_ivid5_piu__eps_channel_t
{
    isismepsv2_ivid5_piu__eps_channel__channel_16v_perm = 0u,
    isismepsv2_ivid5_piu__eps_channel__channel_5v_perm = 1u,
    isismepsv2_ivid5_piu__eps_channel__channel_5v_sw1 = 2u,
    isismepsv2_ivid5_piu__eps_channel__channel_5v_sw2 = 3u,
    isismepsv2_ivid5_piu__eps_channel__channel_5v_sw3 = 4u,
    isismepsv2_ivid5_piu__eps_channel__channel_3v3_perm = 5u,
    isismepsv2_ivid5_piu__eps_channel__channel_3v3_sw1 = 6u,
    isismepsv2_ivid5_piu__eps_channel__channel_3v3_sw2 = 7u,
    isismepsv2_ivid5_piu__eps_channel__channel_3v3_sw3 = 8u,
} isismepsv2_ivid5_piu__eps_channel_t;

/* STRUCTS */

/*!
 *  ISISMEPSV2_IVID5_PIU instance structure
 */
typedef struct
{
    uint8_t i2cAddr; /*!< I2C address used for this instance */
} ISISMEPSV2_IVID5_PIU_t;

/*!
 * Union for storing the parameters for struct ReplyHeader.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__replyheader_t
{
    unsigned char raw[5];
...
} isismepsv2_ivid5_piu__replyheader_t;

/*!
 * Union for storing the parameters for struct VIPDch.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__vipdch_t
{
    unsigned char raw[6];
    struct __attribute__ ((__packed__))
    {
...
} isismepsv2_ivid5_piu__vipdch_t;

/*!
 * Union for storing the parameters for struct VIPDvd.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__vipdvd_t
{
    unsigned char raw[6];
    struct __attribute__ ((__packed__))
    {
...
} isismepsv2_ivid5_piu__vipdvd_t;

/*!
 * Union for storing the parameters for struct VIPDeng.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__vipdeng_t
{
    unsigned char raw[6];
    struct __attribute__ ((__packed__))
    {
...
} isismepsv2_ivid5_piu__vipdeng_t;

/*!
 * Union for storing the parameters for struct BatteryPackStatus.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__batterypackstatus_t
{
    unsigned char raw[2];
    struct __attribute__ ((__packed__))
    {
...
} isismepsv2_ivid5_piu__batterypackstatus_t;

/*!
 * Union for storing the parameters for struct CCSDraw.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__ccsdraw_t
{
    unsigned char raw[8];
    struct __attribute__ ((__packed__))
    {
...
} isismepsv2_ivid5_piu__ccsdraw_t;

/*!
 * Union for storing the parameters for struct CCSDeng.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__ccsdeng_t
{
    unsigned char raw[8];
    struct __attribute__ ((__packed__))
    {
...
} isismepsv2_ivid5_piu__ccsdeng_t;

/*!
 * Union for storing the parameters received by getconfigurationparameter.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__getconfigurationparameter__from_t
{
    unsigned char raw[16];
    struct __attribute__ ((__packed__))
    {
        isismepsv2_ivid5_piu__replyheader_t reply_header; /*!<  */
        uint8_t reserved; /*!<  */
...
} isismepsv2_ivid5_piu__getconfigurationparameter__from_t;
...
} isismepsv2_ivid5_piu__gethousekeepingeng__from_t;

/*!
 * Union for storing the parameters received by gethousekeepingengincdb.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__gethousekeepingengincdb__from_t
{
    ...
    struct __attribute__ ((__packed__))
    {
        ...
        isismepsv2_ivid5_piu__ccsdeng_t cc2; /*!< Data on conditioning chain */
        isismepsv2_ivid5_piu__ccsdeng_t cc3; /*!< Data on conditioning chain */
        isismepsv2_ivid5_piu__vipdeng_t vip_obc09; /*!< Output V, I and P of output bus channel */
        isismepsv2_ivid5_piu__vipdeng_t vip_obc10; /*!< Output V, I and P of output bus channel */
        isismepsv2_ivid5_piu__vipdeng_t vip_obc11; /*!< Output V, I and P of output bus channel */
        isismepsv2_ivid5_piu__vipdeng_t vip_obc12; /*!< Output V, I and P of output bus channel */
        isismepsv2_ivid5_piu__vipdeng_t vip_obc13; /*!< Output V, I and P of output bus channel */
        isismepsv2_ivid5_piu__vipdeng_t vip_obc14; /*!< Output V, I and P of output bus channel */
        isismepsv2_ivid5_piu__vipdeng_t vip_obc15; /*!< Output V, I and P of output bus channel */
        isismepsv2_ivid5_piu__ccsdeng_t cc4; /*!< Data on conditioning chain */
        isismepsv2_ivid5_piu__ccsdeng_t cc5; /*!< Data on conditioning chain */
    } fields;
} isismepsv2_ivid5_piu__gethousekeepingengincdb__from_t;

/*!
 * Union for storing the parameters received by gethousekeepingengrunningavgincdb.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__gethousekeepingengrunningavgincdb__from_t
{
    unsigned char raw[174];
    struct __attribute__ ((__packed__))
    {
...
} isismepsv2_ivid5_piu__gethousekeepingengrunningavgincdb__from_t;

/*!
 * Union for storing the parameters received by gethousekeepingraw.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__gethousekeepingraw__from_t
{
    unsigned char raw[116];
    struct __attribute__ ((__packed__))
    {
        ...
        isismepsv2_ivid5_piu__vipdch_t vip_obc02; /*!< Output V, I and P of output bus channel in raw form */
        ...
        isismepsv2_ivid5_piu__vipdch_t vip_obc06; /*!< Output V, I and P of output bus channel in raw form */
        isismepsv2_ivid5_piu__vipdch_t vip_obc07; /*!< Output V, I and P of output bus channel in raw form */
        isismepsv2_ivid5_piu__vipdch_t vip_obc08; /*!< Output V, I and P of output bus channel in raw form */
...
} isismepsv2_ivid5_piu__gethousekeepingraw__from_t;

/*!
 * Union for storing the parameters received by gethousekeepingrawincdb.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__gethousekeepingrawincdb__from_t
{
    unsigned char raw[174];
    struct __attribute__ ((__packed__))
    {
        ...
        isismepsv2_ivid5_piu__ccsdraw_t cc2; /*!< Data on conditioning chain in raw form. */
        isismepsv2_ivid5_piu__ccsdraw_t cc3; /*!< Data on conditioning chain in raw form. */
        isismepsv2_ivid5_piu__vipdch_t vip_obc09; /*!< Output V, I and P of output bus channel in raw form */
        isismepsv2_ivid5_piu__vipdch_t vip_obc10; /*!< Output V, I and P of output bus channel in raw form */
        isismepsv2_ivid5_piu__vipdch_t vip_obc11; /*!< Output V, I and P of output bus channel in raw form */
        isismepsv2_ivid5_piu__vipdch_t vip_obc12; /*!< Output V, I and P of output bus channel in raw form */
        isismepsv2_ivid5_piu__vipdch_t vip_obc13; /*!< Output V, I and P of output bus channel in raw form */
        isismepsv2_ivid5_piu__vipdch_t vip_obc14; /*!< Output V, I and P of output bus channel in raw form */
        isismepsv2_ivid5_piu__vipdch_t vip_obc15; /*!< Output V, I and P of output bus channel in raw form */
        isismepsv2_ivid5_piu__ccsdraw_t cc4; /*!< Data on conditioning chain in raw form. */
        isismepsv2_ivid5_piu__ccsdraw_t cc5; /*!< Data on conditioning chain in raw form. */
    } fields;
} isismepsv2_ivid5_piu__gethousekeepingrawincdb__from_t;

/*!
 * Union for storing the parameters received by gethousekeepingrunningavg.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__gethousekeepingrunningavg__from_t
{
    unsigned char raw[116];
    struct __attribute__ ((__packed__))
    {
...
} isismepsv2_ivid5_piu__gethousekeepingrunningavg__from_t;

/*!
 * Union for storing the parameters received by getovercurrentfaultstate.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__getovercurrentfaultstate__from_t
{
...
} isismepsv2_ivid5_piu__getovercurrentfaultstate__from_t;

/*!
 * Union for storing the parameters received by getsystemstatus.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__getsystemstatus__from_t
{
...
} isismepsv2_ivid5_piu__getsystemstatus__from_t;

/*!
 * Union for storing the parameters received by resetconfigurationparameter.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__resetconfigurationparameter__from_t
{
    unsigned char raw[16];
    struct __attribute__ ((__packed__))
    {
...
} isismepsv2_ivid5_piu__resetconfigurationparameter__from_t;

/*!
 * Union for storing the parameters sent by setconfigurationparameter.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__setconfigurationparameter__to_t
{
...
} isismepsv2_ivid5_piu__setconfigurationparameter__to_t;

/*!
 * Union for storing the parameters received by setconfigurationparameter.
 */
typedef union __attribute__((__packed__)) _isismepsv2_ivid5_piu__setconfigurationparameter__from_t
{
    unsigned char raw[16];
    struct __attribute__ ((__packed__))
    {
...
} isismepsv2_ivid5_piu__setconfigurationparameter__from_t;

#ifdef __cplusplus
}
#endif

#endif /* ISISMEPSV2_IVID5_PIU_TYPES_H_ */
