...
#ifndef ISIS_ANTS_REV2_TYPES_H_
#define ISIS_ANTS_REV2_TYPES_H_
...
#define ISIS_ANTS_REV2_DEPLOY1_ID {0xA1}
#define ISIS_ANTS_REV2_DEPLOY2_ID {0xA2}
#define ISIS_ANTS_REV2_DEPLOY1_REDUNDANT_ID {0xA3}
#define ISIS_ANTS_REV2_DEPLOY2_REDUNDANT_ID {0xA4}
#define ISIS_ANTS_REV2_START_AUTO_DEPLOY_ID {0xA5}
#define ISIS_ANTS_REV2_START_AUTO_DEPLOY_REDUNDANT_ID {0xA6}
#define ISIS_ANTS_REV2_CANCEL_DEPLOY_ID {0xA9}
#define ISIS_ANTS_REV2_RESET_ID {0xAA}
#define ISIS_ANTS_REV2_DISARM_ID {0xAC}
#define ISIS_ANTS_REV2_ARM_ID {0xAD}
#define ISIS_ANTS_REV2_GET_DEPLOY1_COUNT_ID {0xB0}
#define ISIS_ANTS_REV2_GET_DEPLOY2_COUNT_ID {0xB1}
#define ISIS_ANTS_REV2_GET_DEPLOY1_REDUNDANT_COUNT_ID {0xB2}
#define ISIS_ANTS_REV2_GET_DEPLOY2_REDUNDANT_COUNT_ID {0xB3}
#define ISIS_ANTS_REV2_GET_DEPLOY1_TIME_ID {0xB4}
#define ISIS_ANTS_REV2_GET_DEPLOY2_TIME_ID {0xB5}
#define ISIS_ANTS_REV2_GET_DEPLOY1_REDUNDANT_TIME_ID {0xB6}
#define ISIS_ANTS_REV2_GET_DEPLOY2_REDUNDANT_TIME_ID {0xB7}
#define ISIS_ANTS_REV2_DEPLOY1_OVERRIDE_ID {0xBA}
#define ISIS_ANTS_REV2_DEPLOY2_OVERRIDE_ID {0xBB}
#define ISIS_ANTS_REV2_DEPLOY1_REDUNDANT_OVERRIDE_ID {0xBC}
#define ISIS_ANTS_REV2_DEPLOY2_REDUNDANT_OVERRIDE_ID {0xBD}
#define ISIS_ANTS_REV2_GET_TEMPERATURE_ID {0xC0}
#define ISIS_ANTS_REV2_GET_STATUS_ID {0xC3}
#define ISIS_ANTS_REV2_GET_IDTIMELEFT_ID {0xC4}
#define ISIS_ANTS_REV2_CANCEL_ID_ID {0xC5}
#define ISIS_ANTS_REV2_GET_UPTIME_ID {0xC6}
#define ISIS_ANTS_REV2_GET_ALL_TELEMETRY_ID {0xC7}
#define ISIS_ANTS_REV2_GET_ALL_TELEMETRY_REVA_ID {0xC7}
#define ISIS_ANTS_REV2_CLEAR_WDG_ID {0xCC}
...
/*!
 *  ISIS_ANTS_REV2 instance structure
 */
typedef struct
{
 ...
 */
typedef union __attribute__((__packed__)) _isis_ants_rev2__deploymenttelemetry_t
{
    unsigned char raw[2];
...
} isis_ants_rev2__deploymenttelemetry_t;

/*!
 * Union for storing the parameters received by get_all_telemetry.
 */
typedef union __attribute__((__packed__)) _isis_ants_rev2__get_all_telemetry__from_t
{
    unsigned char raw[11];
    struct __attribute__ ((__packed__))
    {
        uint16_t temperature; /*!< Raw 10 bits measurement of the temperature \note conversion: eng. value [in C] = -0.2922 * raw + 190.65*/
        uint16_t voltage; /*!< Raw 10 bits measurement of the voltage \note conversion: eng. value [in V] = 0.01965444793 * raw + 0*/
        isis_ants_rev2__deploymenttelemetry_t deployment_status; /*!< Antenna deployment status */
        uint32_t uptime; /*!< Uptime value in seconds */
        uint8_t update_flag; /*!< Data updated flag, 0 - not updated, 255 - updated */
    } fields;
} isis_ants_rev2__get_all_telemetry__from_t;

/*!
 * Union for storing the parameters received by get_all_telemetry_reva.
 */
typedef union __attribute__((__packed__)) _isis_ants_rev2__get_all_telemetry_reva__from_t
{
    unsigned char raw[9];
    struct __attribute__ ((__packed__))
    {
...
} isis_ants_rev2__get_all_telemetry_reva__from_t;

/*!
 * Union for storing the parameters received by get_temperature.
 */
typedef union __attribute__((__packed__)) _isis_ants_rev2__get_temperature__from_t
{
    unsigned char raw[3];
    struct __attribute__ ((__packed__))
    {
...
} isis_ants_rev2__get_temperature__from_t;

#ifdef __cplusplus
}
#endif

#endif /* ISIS_ANTS_REV2_TYPES_H_ */
